...
middle_index = (list_length/2)+0.5-1 #modify this line to perform the correct operation
print("Middle index is ",middle_index)
# use [] to access the middle element. Set it equal to middle_element
middle_element = odd_list[int(middle_index)] #modify this line to perform the correct operation
