...
def calculate_stress(force, sample_diameter):
    ...
    ### your code here ###
    cs_area = 0.25 * math.pi * (sample_diameter ** 2)
    # calculate stress (MPa) from load (kN) and cross-sectional area
    ### your code here ###
    stress = force / cs_area
...
def calculate_elastic_modulus(strain, stress):
    ...
    linear_stress = stress[0:1000]
    linear_strain = strain[0:1000]
    ...
    poly = np.polyfit(linear_stress,linear_strain,1)
    slope = poly[0]
    intercept = poly[1]
