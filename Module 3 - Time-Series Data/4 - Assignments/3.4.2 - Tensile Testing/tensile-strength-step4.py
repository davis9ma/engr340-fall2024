...
def calculate_stress(force, sample_diameter):
    ...
    ### your code here ###
    cs_area = (1/4) * math.pi * (sample_diameter ** 2)
    # calculate stress (MPa) from load (kN) and cross-sectional area
    ### your code here ###
    stress = ((force)/(cs_area))*1000
...
def calculate_elastic_modulus(strain, stress):
    ...
    slope1 = np.polyfit(linear_strain,linear_stress,1)
    intercept1 = np.polyfit(linear_strain,linear_stress,1)
    slope = slope1[0]
